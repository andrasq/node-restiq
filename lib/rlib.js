...
// FIXME: tentative
    ...
    function readBody( req, res, next ) {
        ...
        var readTimeout = req.restiq._opts.readTimeout;
        ...
        // loop using setTimeout by default
        if (readTimeout === undefined) readTimeout = true;
        ...
        req.on('end', function() {
            req._bodyEof = true;
            if (1) req.body = readBinary ? new Buffer(data, 'binary') : data;
