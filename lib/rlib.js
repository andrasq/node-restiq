...
module.exports = (function() {
    ...
    function _tryDecodeBody( req, type ) {
        ...
        try { var body = decodeBody(type, req.body); if (body !== undefined) req.body = body; }
    ...
    function buildReadBody(options) {
        ...
        return function readBody( req, res, next ) {
            ...
            var readBinary = req.restiq && req.restiq._opts.readBinary;
            var readImmediate = req.restiq && req.restiq._opts.readImmediate;
            var _returned = false;
            ...
            req.on('error', function(err) {
                req._bodyEof = true;
                var msg = "error reading request body" + ((req.restiq && req.restiq._opts.debug) ? (": " + err.stack) : "");
