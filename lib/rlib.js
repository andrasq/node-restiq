...
module.exports = (function() {
    var paramDecoders = {
        ...
        'application/octet-stream':             function decodeOctets(s) { return new Buffer(s) },
    ...
    var responseEncoders = {
        ...
        'application/octet-stream':             function encodeOctets(s) { return s.toString('base64') },
    ...
    function parseBody( req, res, next ) {
        module.exports.readBody(req, res, function(err) {
            ...
            if (!err) {
                ...
                var err, type = req.headers && req.headers['content-type'];
// FIXME: tentative
                if (!type) {
                    ...
                    // base64 bson
                    else if (req.body.length <= 10000 && req.body.match(/^[0-9a-fA-F+/]*=*$/)) type = 'base64';
                    else if (req.body.length > 10000 && req.body.slice(0, 10000).match(/^[0-9a-fA-F+/]*=*$/)) type = 'base64';
