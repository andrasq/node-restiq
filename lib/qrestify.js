...
module.exports = {
    ...
    addRestifyMethodsToReqRes: addRestifyMethodsToReqRes,
};
...
function addRestifyMethodsToReqRes( req, res ) {
    ...
    res.send = function res_send( statusCode, body, headers) {
        ...
        // note: restify sends application/json by default, even for text
        ...
        // emulate _body, containing the un-encoded object as received
        res._body = body;
        ...
        // set all the specified headers, letting caller override defaults
    ...
    res.json = function res_json(statusCode, body) {
        ...
        this.send(statusCode, JSON.stringify(body), { 'Content-Type': 'application/json' });
        res._body = body;
    };
    // TODO:
    // charSet(type)
